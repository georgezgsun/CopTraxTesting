...
MsgBox($MB_OK, $mMB, "Gears are all ready. Testing start..." & $logFile & @CRLF & "Esc to quit", 2)
...
Func testCamera()
   ...
   $screenFile = FileOpen($screenFile)
   $screenFile = FileRead($screenFile)
...
Func checkCommand()
   ...
   Switch $Recv ; The last hotkey pressed.
